...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html suppressHydrationWarning>
      ...
      <body className={`${inter.variable} h-full bg-so-bg text-so-text font-sans antialiased`}>
        ...
        <PreferencesProvider>
          ...
          >
            <CountryProvider>
              <ContextProvider>
                <TopicProvider>
                  <div className="flex h-full min-h-screen flex-col bg-so-bg">
                    {/* Desktop Header */}
                    ...
                    <div className="grid grow min-h-0 grid-cols-12 mobile-content-offset md:pt-0">
                      {/* Desktop Sidebar */}
                      <aside className="hidden min-h-0 overflow-y-auto so-sidebar md:col-span-3 md:flex lg:col-span-2">
