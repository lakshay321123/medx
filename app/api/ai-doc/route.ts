...
export const maxDuration = 60; // reduce 504s
...
export async function POST(req: NextRequest) {
  try {
    ...
    // Opportunistic preference capture
    ...
    // Always valid JSON back to client
    return NextResponse.json({
      reply: "I captured your note. There was a temporary issue processing the request, but you can continue.",
