...
export async function POST(req: NextRequest) {
  ...
  const brevitySystem = [
    ...
    'Before answering, show your reasoning wrapped in <thinking> tags.',
    'Inside <thinking>, briefly explain (3-6 lines):',
    '- What the user is really asking',
    '- Key medical concepts involved',  
    '- What evidence/guidelines apply',
    'Then give your full answer after the </thinking> tag.',
    '',
