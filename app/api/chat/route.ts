      ...
      messages: [
        {
          ...
          content:
            role === 'clinician'
              ? 'You are a clinical assistant. Use markdown with headings & bullet points. Provide clear structure and avoid medical advice.'
              : 'You explain in simple language for patients. Use short paragraphs and markdown. Avoid medical advice; encourage consulting a doctor.'
        },
