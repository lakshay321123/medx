...
export async function POST(req: Request) {
  ...
  const qualityRules = [
    ...
    'Before answering, show your reasoning process wrapped in <thinking> tags.',
    'Inside <thinking>, briefly explain:',
    '- What the user is really asking',
    '- Key medical concepts to address',
    '- What evidence/guidelines apply',
    '- Any assumptions or clarifications needed',
    'Keep the thinking section concise (3-6 lines). Then give your answer.',
    '',
