...
export default function LegalPrivacyFooter() {
  ...
  return (
    <>
      ...
      >
        <div className="mobile-footer-inner mx-auto flex w-full max-w-screen-2xl items-center justify-center gap-1.5 px-6 text-center text-[11px] text-slate-600 dark:text-slate-300 md:gap-3 md:py-1.5 md:pl-16 md:text-xs">
          <div
