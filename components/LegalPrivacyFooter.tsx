...
export default function LegalPrivacyFooter() {
  ...
  return (
    <>
      <footer
        ref={footerRef}
        className="mobile-footer flex-shrink-0 border-t border-black/10 bg-white dark:bg-slate-950 md:bg-white/80 md:backdrop-blur-sm dark:border-white/10 md:dark:bg-slate-900/60"
      >
