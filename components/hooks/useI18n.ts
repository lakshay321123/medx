...
const BASE_DICTIONARY: Record<string, Record<string, string>> = {
  ...
  hi: {
    ...
    "Retrying…": "फिर से प्रयास किया जा रहा है…",
    "We’ll try again using your last request.": "हम आपकी पिछली अनुरोध का उपयोग करके फिर से प्रयास करेंगे।",
  ...
  fr: {
    ...
    "Couldn’t load timeline. Retrying…": "Impossible de charger la chronologie. Nouvel essai…",
    "Network error": "Erreur réseau",
    Retry: "Réessayer",
    "Retrying…": "Nouvelle tentative…",
    "We’ll try again using your last request.": "Nous réessaierons avec votre dernière requête.",
