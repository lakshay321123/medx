...
const BASE_DICTIONARY: Record<string, Record<string, string>> = {
  en: {
    ...
    "Delete project? This won’t delete chats.": "Delete project? This won’t delete chats.",
    "Drop a chat here": "Drop a chat here",
    General: "General",
  ...
  hi: {
    ...
    "Delete project? This won’t delete chats.": "प्रोजेक्ट हटाएँ? इससे चैट्स नहीं हटेंगी।",
    "Drop a chat here": "चैट को यहाँ छोड़ें",
    General: "जनरल",
  ...
  ar: {
    ...
    "Delete project? This won’t delete chats.": "حذف المشروع؟ لن يؤدي ذلك إلى حذف المحادثات.",
    "Drop a chat here": "أسقط محادثة هنا",
    General: "عام",
  ...
  it: {
    ...
    "Delete project? This won’t delete chats.": "Eliminare il progetto? Le chat non verranno eliminate.",
    "Drop a chat here": "Trascina una chat qui",
    General: "Generale",
  ...
  zh: {
    ...
    "Delete project": "删除项目",
    "Delete project? This won’t delete chats.": "删除项目？不会删除聊天。",
    "Drop a chat here": "将聊天拖到此处",
    General: "通用",
    Notifications: "通知",
    Personalization: "个性化",
    Connectors: "连接器",
  ...
  es: {
    ...
    "Delete project? This won’t delete chats.": "¿Eliminar el proyecto? Esto no eliminará los chats.",
    "Drop a chat here": "Suelta un chat aquí",
    General: "General",
  ...
  fr: {
    ...
    "Delete project? This won’t delete chats.": "Supprimer le projet ? Cela ne supprimera pas les discussions.",
    "Drop a chat here": "Déposez une discussion ici",
  },
};
