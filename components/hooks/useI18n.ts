...
const BASE_DICTIONARY: Record<string, Record<string, string>> = {
  en: {
    ...
    "ui.composer.thinking_mode": "Thinking Mode",
    "upload": "Upload photos/files",
    "studyLearn": "Study & Learn",
    "thinkingMode": "Thinking Mode",
    "more": "More",
    "clearSelection": "Clear selection",
    "composerMenu": "Composer options",
    "ui.composer.send_aria": "Send message",
    "ui.composer.upload_aria": "Upload a photo or file",
    ...
    "Symptoms & Notes": "Symptoms & Notes",
    "Add notes": "Add notes",
    "profile.common.noItems": "No items yet.",
    "profile.common.notRecorded": "Not recorded",
    "profile.common.validateEntries": "Check required fields and try again.",
    "profile.common.saved": "Saved",
    "profile.common.saveFailed": "Couldn’t save changes",
    "profile.common.add": "Add",
    "profile.common.edit": "Edit",
    "profile.common.cancel": "Cancel",
    "profile.common.saveChanges": "Save changes",
    "profile.common.saving": "Saving…",
    "profile.common.delete": "Delete",
    "profile.common.close": "Close",
    "profile.common.pleaseRetry": "Please try again.",
    "profile.familyHistory.title": "Family history",
    "profile.familyHistory.add": "Add family history",
    "profile.familyHistory.relation": "Relation",
    "profile.familyHistory.relation.father": "Father",
    "profile.familyHistory.relation.mother": "Mother",
    "profile.familyHistory.relation.sibling": "Sibling",
    "profile.familyHistory.relation.child": "Child",
    "profile.familyHistory.condition": "Condition",
    "profile.familyHistory.onsetAge": "Onset age",
    "profile.immunizations.title": "Immunizations",
    "profile.immunizations.add": "Add vaccine",
    "profile.immunizations.vaccine": "Vaccine",
    "profile.immunizations.date": "Date",
    "profile.immunizations.lot": "Lot",
    "profile.immunizations.source": "Source / proof",
    "profile.immunizations.invalidDate": "Enter a valid date",
    "profile.immunizations.invalidUrl": "Enter a valid URL",
    "profile.lifestyle.title": "Social & lifestyle",
    "profile.lifestyle.smoking": "Smoking",
    "profile.lifestyle.alcohol": "Alcohol",
    "profile.lifestyle.packsPerDay": "Packs/day",
    "profile.lifestyle.years": "Years",
    "profile.lifestyle.unitsPerWeek": "Units/week",
    "profile.lifestyle.drugs": "Drugs",
    "profile.lifestyle.diet": "Diet",
    "profile.lifestyle.activity": "Activity",
    "profile.lifestyle.sleep": "Sleep",
    "profile.lifestyle.occupation": "Occupation",
    "profile.lifestyle.exposures": "Exposures",
    "profile.lifestyle.none": "None",
    "profile.lifestyle.former": "Former",
    "profile.lifestyle.current": "Current",
    "profile.lifestyle.occasional": "Occasional",
    "profile.lifestyle.regular": "Regular",
    "profile.lifestyle.helper": "Optional context to personalize care recommendations.",
    "profile.lifestyle.invalidSmoking": "Enter valid smoking details",
    "profile.lifestyle.invalidAlcohol": "Enter a valid weekly total",
    "profile.surgeries.title": "Past surgeries",
    "profile.surgeries.add": "Add surgery",
    "profile.surgeries.procedure": "Procedure",
    "profile.surgeries.date": "Date",
    "profile.surgeries.notes": "Notes",
    "profile.surgeries.invalidDate": "Enter a valid surgery date",
    "profile.accessibility.title": "Accessibility needs",
    "profile.accessibility.mobility": "Mobility",
    "profile.accessibility.vision": "Vision",
    "profile.accessibility.hearing": "Hearing",
    "profile.accessibility.communication": "Communication",
    "profile.advanceDirectives.title": "Advance directives",
    "profile.advanceDirectives.codeStatus": "Code status",
    "profile.advanceDirectives.surrogateName": "Surrogate name",
    "profile.advanceDirectives.surrogatePhone": "Surrogate phone",
    "profile.advanceDirectives.documentUrl": "Document URL",
    "profile.advanceDirectives.FULL": "Full code",
    "profile.advanceDirectives.DNR": "Do not resuscitate (DNR)",
    "profile.advanceDirectives.DNI": "Do not intubate (DNI)",
    "profile.advanceDirectives.add": "Add advance directive",
    "profile.advanceDirectives.invalidUrl": "Enter a valid document link",
  ...
  hi: {
    ...
    "ui.composer.thinking_mode": "सोचने का मोड",
    "upload": "फ़ोटो/फ़ाइलें अपलोड करें",
    "studyLearn": "अध्ययन और सीखें",
    "thinkingMode": "सोचने का मोड",
    "more": "अधिक",
    "clearSelection": "चयन साफ़ करें",
    "composerMenu": "कंपोज़र विकल्प",
    "ui.composer.send_aria": "संदेश भेजें",
    "ui.composer.upload_aria": "फ़ोटो या फ़ाइल अपलोड करें",
    ...
    Edit: "संपादित करें",
    Done: "पूर्ण",
    "profile.common.add": "जोड़ें",
    "profile.common.edit": "संपादित करें",
    "profile.common.cancel": "रद्द करें",
    "profile.common.saveChanges": "परिवर्तन सहेजें",
    "profile.common.saving": "सहेजा जा रहा है…",
    "profile.common.delete": "हटाएं",
    "profile.common.close": "बंद करें",
    "profile.common.pleaseRetry": "कृपया फिर से प्रयास करें।",
  ...
  ar: {
    ...
    "ui.composer.thinking_mode": "وضع التفكير",
    "upload": "تحميل الصور/الملفات",
    "studyLearn": "الدراسة والتعلم",
    "thinkingMode": "وضع التفكير",
    "more": "المزيد",
    "clearSelection": "مسح التحديد",
    "composerMenu": "خيارات المحرر",
    "ui.composer.send_aria": "إرسال رسالة",
    "ui.composer.upload_aria": "تحميل صورة أو ملف",
  ...
  it: {
    ...
    "ui.composer.thinking_mode": "Modalità pensiero",
    "upload": "Carica foto/file",
    "studyLearn": "Studia e impara",
    "thinkingMode": "Modalità pensiero",
    "more": "Altro",
    "clearSelection": "Cancella selezione",
    "composerMenu": "Opzioni del compositore",
    "ui.composer.send_aria": "Invia messaggio",
    "ui.composer.upload_aria": "Carica una foto o un file",
  ...
  zh: {
    ...
    "ui.composer.thinking_mode": "思考模式",
    "upload": "上传照片/文件",
    "studyLearn": "学习与了解",
    "thinkingMode": "思考模式",
    "more": "更多",
    ...
    "ui.composer.upload_aria": "上传照片或文件",
    "Network error": "网络错误",
    Retry: "重试",
    "Retrying…": "正在重试…",
  ...
  es: {
    ...
    "ui.composer.thinking_mode": "Modo de pensamiento",
    "upload": "Subir fotos/archivos",
    "studyLearn": "Estudiar y aprender",
    "thinkingMode": "Modo de pensamiento",
    "more": "Más",
    "clearSelection": "Borrar selección",
    "composerMenu": "Opciones del compositor",
    "ui.composer.send_aria": "Enviar mensaje",
    "ui.composer.upload_aria": "Subir una foto o archivo",
    ...
    "profile.common.noItems": "Aún no hay elementos.",
    "profile.common.notRecorded": "No registrado",
    "profile.common.validateEntries": "Revisa los campos obligatorios e inténtalo de nuevo.",
    "profile.common.saved": "Guardado",
    "profile.common.saveFailed": "No se pudieron guardar los cambios",
    "profile.common.add": "Agregar",
    "profile.common.edit": "Editar",
    "profile.common.cancel": "Cancelar",
    "profile.common.saveChanges": "Guardar cambios",
    "profile.common.saving": "Guardando…",
    "profile.common.delete": "Eliminar",
    "profile.common.close": "Cerrar",
    "profile.common.pleaseRetry": "Vuelve a intentarlo.",
    "profile.familyHistory.title": "Antecedentes familiares",
    "profile.familyHistory.add": "Agregar antecedente familiar",
    "profile.familyHistory.relation": "Relación",
    "profile.familyHistory.relation.father": "Padre",
    "profile.familyHistory.relation.mother": "Madre",
    "profile.familyHistory.relation.sibling": "Hermano/a",
    "profile.familyHistory.relation.child": "Hijo/a",
    "profile.familyHistory.condition": "Condición",
    "profile.familyHistory.onsetAge": "Edad de inicio",
    "profile.immunizations.title": "Vacunas",
    "profile.immunizations.add": "Agregar vacuna",
    "profile.immunizations.vaccine": "Vacuna",
    "profile.immunizations.date": "Fecha",
    "profile.immunizations.lot": "Lote",
    "profile.immunizations.source": "Fuente / comprobante",
    "profile.immunizations.invalidDate": "Ingresa una fecha válida",
    "profile.immunizations.invalidUrl": "Ingresa una URL válida",
    "profile.lifestyle.title": "Estilo de vida",
    "profile.lifestyle.smoking": "Tabaquismo",
    "profile.lifestyle.alcohol": "Alcohol",
    "profile.lifestyle.packsPerDay": "Paquetes/día",
    "profile.lifestyle.years": "Años",
    "profile.lifestyle.unitsPerWeek": "Unidades/semana",
    "profile.lifestyle.drugs": "Drogas",
    "profile.lifestyle.diet": "Dieta",
    "profile.lifestyle.activity": "Actividad",
    "profile.lifestyle.sleep": "Sueño",
    "profile.lifestyle.occupation": "Ocupación",
    "profile.lifestyle.exposures": "Exposiciones",
    "profile.lifestyle.none": "Ninguno",
    "profile.lifestyle.former": "Ex",
    "profile.lifestyle.current": "Actual",
    "profile.lifestyle.occasional": "Ocasional",
    "profile.lifestyle.regular": "Regular",
    "profile.lifestyle.helper": "Información opcional para personalizar las recomendaciones.",
    "profile.lifestyle.invalidSmoking": "Ingresa datos de tabaquismo válidos",
    "profile.lifestyle.invalidAlcohol": "Ingresa un total semanal válido",
    "profile.surgeries.title": "Cirugías previas",
    "profile.surgeries.add": "Agregar cirugía",
    "profile.surgeries.procedure": "Procedimiento",
    "profile.surgeries.date": "Fecha",
    "profile.surgeries.notes": "Notas",
    "profile.surgeries.invalidDate": "Ingresa una fecha de cirugía válida",
    "profile.accessibility.title": "Necesidades de accesibilidad",
    "profile.accessibility.mobility": "Movilidad",
    "profile.accessibility.vision": "Visión",
    "profile.accessibility.hearing": "Audición",
    "profile.accessibility.communication": "Comunicación",
    "profile.advanceDirectives.title": "Instrucciones previas",
    "profile.advanceDirectives.codeStatus": "Código de reanimación",
    "profile.advanceDirectives.surrogateName": "Nombre del representante",
    "profile.advanceDirectives.surrogatePhone": "Teléfono del representante",
    "profile.advanceDirectives.documentUrl": "URL del documento",
    "profile.advanceDirectives.FULL": "Código completo",
    "profile.advanceDirectives.DNR": "No resucitar (DNR)",
    "profile.advanceDirectives.DNI": "No intubar (DNI)",
    "profile.advanceDirectives.invalidUrl": "Ingresa un enlace válido",
    "profile.advanceDirectives.add": "Agregar instrucciones previas",
  ...
  fr: {
    ...
    "upload": "Téléverser des photos/fichiers",
    "studyLearn": "Étudier et apprendre",
