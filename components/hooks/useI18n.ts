...
const BASE_DICTIONARY: Record<string, Record<string, string>> = {
  en: {
    ...
    "ui.composer.upload": "Attach",
    "ui.composer.send_aria": "Send message",
    "ui.composer.upload_aria": "Attach files",
    "ui.composer.newline_hint": "Shift + Enter for newline",
  ...
  hi: {
    ...
    "ui.composer.upload": "संलग्न करें",
    "ui.composer.send_aria": "संदेश भेजें",
    "ui.composer.upload_aria": "फ़ाइल संलग्न करें",
    "ui.composer.newline_hint": "नई पंक्ति के लिए Shift + Enter",
  ...
  ar: {
    ...
    "ui.composer.upload": "إرفاق",
    "ui.composer.send_aria": "إرسال رسالة",
    "ui.composer.upload_aria": "إرفاق ملفات",
    "ui.composer.newline_hint": "اضغط Shift + Enter لسطر جديد",
  ...
  it: {
    ...
    "ui.composer.upload": "Allega",
    "ui.composer.send_aria": "Invia messaggio",
    "ui.composer.upload_aria": "Allega file",
    "ui.composer.newline_hint": "Maiusc + Invio per andare a capo",
    "ui.nav.directory": "Directory",
  ...
  zh: {
    ...
    "ui.composer.send": "发送",
    "ui.composer.upload": "添加附件",
    "ui.composer.send_aria": "发送消息",
    "ui.composer.upload_aria": "附加文件",
    "ui.composer.newline_hint": "按 Shift + Enter 换行",
    "ui.nav.directory": "目录",
  ...
  es: {
    ...
    "ui.composer.upload": "Adjuntar",
    "ui.composer.send_aria": "Enviar mensaje",
    "ui.composer.upload_aria": "Adjuntar archivos",
    "ui.composer.newline_hint": "Mayús + Enter para nueva línea",
