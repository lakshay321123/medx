...
const BASE_DICTIONARY: Record<string, Record<string, string>> = {
  en: {
    ...
    "Add a medication": "Add a medication",
    "Profile saved": "Profile saved",
    "Couldn’t save profile": "Couldn’t save profile",
    "Medication removed": "Medication removed",
    "Couldn’t remove medication": "Couldn’t remove medication",
    "Notes saved": "Notes saved",
    "Couldn’t save notes": "Couldn’t save notes",
    "Notes removed": "Notes removed",
    "Couldn’t remove notes": "Couldn’t remove notes",
    "Next steps saved": "Next steps saved",
    "Couldn’t save next steps": "Couldn’t save next steps",
    "Next steps removed": "Next steps removed",
    "Couldn’t remove next steps": "Couldn’t remove next steps",
    "Failed to save medication": "Failed to save medication",
    "Failed to remove medication": "Failed to remove medication",
    "Medication name required": "Medication name required",
    "Medication saved but response was malformed": "Medication saved but response was malformed",
    ...
    "Recompute failed": "Recompute failed",
    ...
    "No prediction yet — add vitals, labs, or medications to compute risk.":
      "No prediction yet — add vitals, labs, or medications to compute risk.",
    "Not enough data to compute risk yet.": "Not enough data to compute risk yet.",
    Timeline: "Timeline",
  ...
  fr: {
    "Add a medication": "Ajouter un médicament",
    "Profile saved": "Profil enregistré",
    "Couldn’t save profile": "Impossible d’enregistrer le profil",
    "Medication removed": "Médicament supprimé",
    "Couldn’t remove medication": "Impossible de supprimer le médicament",
    "Notes saved": "Notes enregistrées",
    "Couldn’t save notes": "Impossible d’enregistrer les notes",
    "Notes removed": "Notes supprimées",
    "Couldn’t remove notes": "Impossible de supprimer les notes",
    "Next steps saved": "Prochaines étapes enregistrées",
    "Couldn’t save next steps": "Impossible d’enregistrer les prochaines étapes",
    "Next steps removed": "Prochaines étapes supprimées",
    "Couldn’t remove next steps": "Impossible de supprimer les prochaines étapes",
    "Failed to save medication": "Échec de l’enregistrement du médicament",
    "Failed to remove medication": "Échec de la suppression du médicament",
    "Medication name required": "Nom du médicament requis",
    "Medication saved but response was malformed": "Médicament enregistré mais réponse mal formée",
    "Recompute failed": "Le nouveau calcul a échoué",
    ...
    "No profile yet.": "Aucun profil pour le moment.",
    "e.g. 170": "ex. 170",
    "e.g. 70": "ex. 70",
    "Full name": "Nom complet",
    "No prediction yet — add vitals, labs, or medications to compute risk.":
      "Aucune prédiction pour le moment — ajoutez des constantes, des analyses ou des médicaments pour calculer le risque.",
    "Not enough data to compute risk yet.": "Pas assez de données pour calculer le risque pour le moment.",
