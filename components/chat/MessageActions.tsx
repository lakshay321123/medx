...
export default function MessageActions({
  ...
  const desktopRow = (
    <div className="absolute right-3 top-3 hidden gap-2 rounded-full bg-white px-2 py-1 text-slate-500 shadow-sm ring-1 ring-slate-200 transition md:right-4 md:top-4 md:-translate-y-2 md:flex md:opacity-0 md:group-hover:opacity-80 md:group-focus-within:opacity-100 dark:bg-[#1f1f1f] dark:text-slate-300 dark:ring-slate-700">
