...
export default function Header() {
  return (
    <header className="sticky top-0 z-40 border-b border-black/10 bg-white dark:bg-slate-950 md:bg-white/80 md:backdrop-blur-md dark:border-white/10 md:dark:bg-slate-900/40">
