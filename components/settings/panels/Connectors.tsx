...
const CONNECTORS: Connector[] = [
  { id: "apple_health", name: "Apple Health", description: "Heart rate, steps, sleep, SpO2", icon: "\u2764\uFE0F", category: "wearable", status: "disconnected" },
  { id: "google_fit", name: "Google Fit", description: "Activity, heart rate, sleep", icon: "\uD83C\uDFC3", category: "wearable", status: "disconnected" },
  { id: "fitbit", name: "Fitbit", description: "Steps, sleep, heart rate, SpO2", icon: "\u231A", category: "wearable", status: "disconnected" },
  { id: "samsung_health", name: "Samsung Health", description: "Galaxy Watch health data", icon: "\uD83D\uDCF1", category: "wearable", status: "disconnected" },
  { id: "garmin", name: "Garmin Connect", description: "Fitness metrics, body battery", icon: "\uD83E\uDDED", category: "wearable", status: "disconnected" },
  { id: "oura", name: "Oura Ring", description: "Sleep quality, readiness, temperature", icon: "\uD83D\uDCAD", category: "wearable", status: "disconnected" },
  { id: "epic_mychart", name: "MyChart (Epic)", description: "Medical records, lab results", icon: "\uD83C\uDFE5", category: "health_record", status: "disconnected" },
  { id: "1mg", name: "1mg / Tata Health", description: "Prescription tracking", icon: "\uD83D\uDC8A", category: "pharmacy", status: "disconnected" },
  { id: "pharmeasy", name: "PharmEasy", description: "Order history, medication tracking", icon: "\uD83D\uDC8A", category: "pharmacy", status: "disconnected" },
  { id: "google_calendar", name: "Google Calendar", description: "Sync appointment reminders", icon: "\uD83D\uDCC5", category: "calendar", status: "disconnected" },
  { id: "thyrocare", name: "Thyrocare", description: "Auto-import lab results", icon: "\uD83E\uDDEA", category: "lab", status: "disconnected" },
  { id: "srl_diagnostics", name: "SRL Diagnostics", description: "Import diagnostic reports", icon: "\uD83E\uDDEA", category: "lab", status: "disconnected" },
];
  ...
  const handleConnect = async (id: string) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        // Status will update via callback/polling — no optimistic update
      }
    } catch (error) {
