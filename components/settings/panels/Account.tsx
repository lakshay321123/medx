...
export default function AccountPanel(){
  ...
  return (
    <div className="space-y-3 p-5">
      ...
      <div className="flex items-center justify-between"><div className="text-[13px]">Sign out</div><button type="button" className="rounded-lg border border-black/10 bg-white/70 px-3 py-1.5 text-sm dark:border-white/10 dark:bg-slate-900/60">Sign out</button></div>
