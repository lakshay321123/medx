...
export default function MobileSidebarOverlay() {
  ...
  return (
    ...
    >
      <div
        ref={panelRef}
        className="relative h-full w-[88%] max-w-[320px] -translate-x-full bg-white dark:bg-slate-950 md:bg-transparent"
        role="dialog"
        aria-modal="true"
      ...
      >
        <div className="h-full overflow-y-auto">
          <div
            className="sticky top-0 z-10 flex h-[64px] items-center justify-between border-b border-black/10 bg-white/95 px-3 backdrop-blur dark:border-white/10 dark:bg-slate-950/95"
            style={{ paddingTop: "env(safe-area-inset-top)" }}
          >
            <img src="/logo.svg" alt="MedX" className="h-7 w-auto" />
            <button
              onClick={close}
          ...
          <div className="px-3 pt-3 pb-[env(safe-area-inset-bottom)]">
