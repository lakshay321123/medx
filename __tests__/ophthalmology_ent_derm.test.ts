...
import "../lib/medical/engine/calculators/ophthalmology_ent_derm";
...
describe("RareSpecialties: calculators present", () => {
...
describe("RareSpecialties: calculators run & shape", () => {
