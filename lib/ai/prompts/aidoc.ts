...
export function buildAiDocPrompt({ profile, labs, meds, conditions }: BuildInput) {
  ...
  return [
    ...
    "- You must read the calculator outputs (above) and then VERIFY them.",
    "- If a calculator result is inconsistent (e.g., K=5.5 labeled normal, measured osmolality 320 labeled normal, PaCO2 marked normal despite Winter’s), you MUST correct it and proceed.",
    "- If you correct, write one short line: 'Correction: <what/why>'.",
    "- Your final clinical conclusion ALWAYS supersedes the calculators.",
    "",
    "Patient Snapshot:",
