// lib/intents.ts
// MedX — Exhaustive Intents Library (Single File, cleaned)
...
export function detectSocialIntentStrict(input: string): SocialIntent {
  ...
  const NO  = new Set(["n","no","stop","hold","cancel","do not","don't","👎"]);
...
export const DOCTOR_DRAFT_STYLE = [
  "FORMAT: Clinical and concise, using bold headers and bullets.",
  "For definition style asks, prefer this outline:",
  "## **Definition (clinical)**",
  "## **Phenotypes**",
...
const PATIENT_SPECS: IntentSpec[] = [
  ...
  { slug: "severity_serious", title: "Serious or red flags", triggers: ["is it serious","should i be worried","red flags","danger signs","emergency"], outline: ["## **Red flags — seek care now**","## **What is okay to watch at home**"] },
  ...
  { slug: "how_to_take", title: "How to take or dosing", triggers: ["how to take","with food","without food","missed dose","timing","schedule"], outline: ["## **How to take it**","## **If you miss a dose**"] },
