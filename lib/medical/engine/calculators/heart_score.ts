...
export type HEARTInputs = {
  history: 0|1|2; // 0 slight, 1 moderate, 2 highly suspicious
  ecg: 0|1|2; // 0 normal, 1 non-specific repolarization, 2 significant ST deviation
  age_group: 0|1|2; // 0 <45, 1 45–65, 2 >65
  risk_factors: 0|1|2; // 0 none, 1 1–2, 2 ≥3 or known atherosclerosis
  troponin: 0|1|2; // relative to lab normal
};
