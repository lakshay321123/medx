export type OsmInputs = { na_mmol_l: number; glucose_mg_dl: number; bun_mg_dl: number; ethanol_mg_dl?: number };
export type SerumOsmInputs = OsmInputs;

export function calc_serum_osmolality(i: OsmInputs): number {
