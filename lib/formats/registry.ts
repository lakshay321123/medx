...
export const FORMATS: FormatMeta[] = [
  ...
  },
  {
    ...
    systemHint: [
      'Return a **single fenced block** with language `table`. No prose before or after.',
      'Inside the block, output a valid Markdown table with EXACT columns:',
      ...
      '| Topic | Mechanism/How it works | Expected benefit | Limitations/Side effects | Notes/Evidence |',
      '|-------|-------------------------|------------------|--------------------------|----------------|',
      '| Minoxidil | Opens K+ channels; prolongs anagen | ↑ density (modest) | Irritation; unwanted hair | RCTs; benefit at 3–6 mo |',
      '```',
    ].join('\n'),
  },
  {
